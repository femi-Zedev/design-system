...
export function MoneyFormatter({ value }: { value: number; decimalScale: number }) {
  return (
    <NumberFormatter
      prefix='$'
      thousandSeparator
...
export function EmptyResultsIllustration() {
  return (
    <svg
      width='119'
      height='104'
    ...
    >
      <path
        d='M59.18 81.83C59.7212 81.83 60.16 81.3912 60.16 80.85C60.16 80.3088 59.7212 79.87 59.18 79.87C58.6387 79.87 58.2 80.3088 58.2 80.85C58.2 81.3912 58.6387 81.83 59.18 81.83Z'
        fill='#CFCFCF'
      />
      <path
      ...
      />
      <path
        d='M66.1199 2.18998C66.6611 2.18998 67.0999 1.75122 67.0999 1.20998C67.0999 0.668741 66.6611 0.22998 66.1199 0.22998C65.5787 0.22998 65.1399 0.668741 65.1399 1.20998C65.1399 1.75122 65.5787 2.18998 66.1199 2.18998Z'
        fill='#CFCFCF'
      />
      <path
        d='M15.2 78.5V82.8'
      ...
      />
      <path
        d='M89.0899 76.88H25.6799C25.2555 76.8797 24.8363 76.7872 24.4512 76.609C24.0661 76.4307 23.7243 76.1709 23.4495 75.8476C23.1746 75.5243 22.9733 75.1451 22.8594 74.7363C22.7456 74.3275 22.7218 73.8989 22.7899 73.48L30.8999 24.3C31.0095 23.6155 31.3598 22.9926 31.8878 22.5435C32.4157 22.0943 33.0867 21.8484 33.7799 21.85H97.1899C97.6139 21.85 98.0329 21.9424 98.4176 22.1208C98.8024 22.2991 99.1436 22.5591 99.4177 22.8827C99.6918 23.2062 99.8921 23.5856 100.005 23.9944C100.117 24.4033 100.14 24.8317 100.07 25.25L91.9999 74.43C91.8876 75.1187 91.5324 75.7444 90.9986 76.1939C90.4648 76.6433 89.7877 76.8867 89.0899 76.88Z'
        fill='#D2D2D2'
      />
      <path
      ...
      />
      <path
        d='M60.83 17.57C61.3989 17.57 61.86 17.1089 61.86 16.54C61.86 15.9712 61.3989 15.51 60.83 15.51C60.2612 15.51 59.8 15.9712 59.8 16.54C59.8 17.1089 60.2612 17.57 60.83 17.57Z'
        fill='#BABABA'
      />
      <path
...
export const SkeletonCard = () => (
  <div className='flex items-center gap-6 my-3 px-4 rounded-md border border-gray-200 py-3'>
